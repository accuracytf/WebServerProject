...
<section class="w-full py-12 md:py-24 lg:py-32 border-b h-screen">
    <div class="container px-4 md:px-6">
        <div class="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <img
                src="assets/photo-1537511446984-935f663eb1f4.avif"
                width="550"
                height="310"
                alt="Hero"
                class="mx-auto aspect-video overfl  ow-hidden rounded-xl object-cover object-center sm:w-full lg:order-last"
            />
        </div>
    </div>
</section>